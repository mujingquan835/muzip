...
#ifndef MUZIP_SWIFT_H
#define MUZIP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MUZIP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSPasteboard;
SWIFT_CLASS("_TtC5MUZIP11AppDelegate")
...
- (void)compressSelection:(NSPasteboard * _Nonnull)pasteboard userData:(NSString * _Nullable)userData error:(NSString * _Nullable * _Nonnull)error;
